...
>
    <div :class="expanded ? '' : 'overflow-hidden'" style="max-height: none;">
        <div :style="expanded ? '' : 'max-height: 5rem; overflow: hidden;'">
            {{ $slot }}
        </div>
    </div>
    <button
        ...
        class="btn btn-sm btn-icon position-absolute bottom-0 end-0 m-1 text-muted border-0 p-1"
    >
